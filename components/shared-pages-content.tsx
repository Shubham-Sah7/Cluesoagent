          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-white border border-[#E8E8E6] rounded-lg p-5">
              <div className="flex items-center gap-2 mb-4">
                <TrendingUp className="w-4 h-4 text-[#8F8CFF]" strokeWidth={1.5} />
        ...
        <section>
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-3">
              <select className="px-3 py-1.5 text-[13px] bg-white border border-[#E8E8E6] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8F8CFF] focus:border-transparent">
