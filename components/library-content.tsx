        ...
        <header className="mb-10">
          ...
          <div className="relative mb-8">
            ...
            <input
              ...
              className="w-full pl-12 pr-20 py-3.5 text-[15px] bg-white border border-[#E8E8E6] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8F8CFF] focus:border-transparent transition-all shadow-sm"
            />
    ...
    <div className="group bg-white border border-[#E8E8E6] rounded-lg overflow-hidden hover:border-[#D4D4D2] hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer relative">
      ...
      <div className="aspect-video bg-[#F5F5F3] relative overflow-hidden">
        ...
        <div className="absolute top-2 left-2 flex gap-1.5">
          ...
          {aiGenerated && (
            <span className="bg-[#F5F5FF]/95 backdrop-blur-sm text-[#8F8CFF] text-[11px] font-medium px-2 py-1 rounded flex items-center gap-1">
