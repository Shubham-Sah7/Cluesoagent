...
function TemplateCard({ template, onClick }: TemplateCardProps) {
  return (
    <button
      onClick={onClick}
      className="group text-left bg-white border border-[#E4E4E7] rounded-[12px] overflow-hidden hover:border-[#8F8CFF] hover:shadow-lg transition-all"
    >
      {/* Real Template Image */}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-[#E4E4E7]">
          <span className="text-[12px] font-medium text-[#8F8CFF]">Use Template</span>
          <ArrowRight className="w-3.5 h-3.5 text-[#8F8CFF]" strokeWidth={1.5} />
        </div>
      </div>
    </button>
  )
      ...
      <div className="bg-white rounded-[16px] w-full max-w-[580px] shadow-xl">
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 border border-[#E4E4E7] rounded-[10px] text-[14px] text-[#111111] placeholder:text-[#A1A1AA] focus:outline-none focus:border-[#8F8CFF] transition-colors"
            />
          </div>
        ...
        <div className="px-6 pb-6 pt-2">
          <button
            ...
            className="w-full py-2.5 bg-[#8F8CFF] hover:bg-[#7B77FF] disabled:bg-[#E4E4E7] disabled:text-[#A1A1AA] text-white font-medium text-[14px] rounded-[10px] transition-colors"
          >
            Continue
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 bg-[#FAFAFA] flex items-center justify-center z-50">
      <div className="w-full max-w-[420px] px-8 text-center">
        ...
        {/* Status */}
        <div className="inline-flex items-center gap-2 bg-[#F5F5FF] text-[#8F8CFF] text-[13px] font-medium px-4 py-2 rounded-full">
  ...
  return (
    <div className="fixed inset-0 bg-[#FAFAFA] z-50 overflow-auto">
      ...
      <div className="sticky top-0 bg-white border-b border-[#E4E4E7] z-10">
        <div className="max-w-[1400px] mx-auto px-8 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="px-4 py-2 bg-[#8F8CFF] hover:bg-[#7B77FF] text-white font-medium text-[14px] rounded-[10px] transition-colors">
              Publish
            </button>
            <button
              onClick={onClose}
      ...
      <div className="max-w-[1400px] mx-auto px-8 py-12">
        ...
        {/* Success Message */}
        <div className="bg-[#F5F5FF] border border-[#8F8CFF]/20 rounded-[12px] p-5 mb-8 flex items-start gap-3">
          <div className="w-8 h-8 rounded-[8px] bg-[#8F8CFF]/10 flex items-center justify-center flex-shrink-0">
            <Check className="w-4 h-4 text-[#8F8CFF]" strokeWidth={2} />
          </div>
          <div>
